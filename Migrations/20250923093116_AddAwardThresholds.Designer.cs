...
namespace KaizenWebApplication.Migrations
{
    ...
    [Migration("20250923093116_AddAwardThresholds")]
    partial class AddAwardThresholds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KaizenWebApp.Models.AwardThreshold", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AwardThresholds");
                });

            modelBuilder.Entity("KaizenWebApp.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KaizenWebApp.Models.Gallery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KaizenWebApp.Models.KaizenMarkingScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MarkingCriteriaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MarkingCriteriaId");

                    b.ToTable("KaizenMarkingScores");
                });

            modelBuilder.Entity("KaizenWebApp.Models.MarkingCriteria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KaizenWebApp.Models.KaizenForm", b =>
                {
                    b.HasOne("KaizenWebApp.Models.Category", null)
                        .WithMany("KaizenForms")
                        .HasForeignKey("CategoryId");
                });

            modelBuilder.Entity("KaizenWebApp.Models.KaizenMarkingScore", b =>
                {
                    b.HasOne("KaizenWebApp.Models.KaizenForm", "Kaizen")
                        .WithMany()
                        .HasForeignKey("KaizenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KaizenWebApp.Models.MarkingCriteria", "MarkingCriteria")
                        .WithMany()
                        .HasForeignKey("MarkingCriteriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Kaizen");

                    b.Navigation("MarkingCriteria");
                });

            modelBuilder.Entity("KaizenWebApp.Models.Category", b =>
                {
                    b.Navigation("KaizenForms");
                });
